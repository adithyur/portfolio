        ...
        <div className='mx-2 md:mx-20 lg:mx-20 xl:mx-40'>
            ...
            <div id='home' ref={el => sections.current['#home'] = el}>
                ...
                <div className='container mx-auto flex items-center justify-center mt-8'>
                    <a href='#about' className='explr-btn hover:text-black flex items-center px-4 py-2'>
                        <span className='font-bold text-2xl tracking-wide'>Examine More</span>
                        <div className="icon-container">
                            <FaChevronDown size={18} className='mt-1 ms-2 icon blink-delay-1' />
                            <FaChevronDown size={18} className='-mt-3 ms-2 icon blink-delay-2' />
                            <FaChevronDown size={18} className='-mt-3 ms-2 icon blink-delay-3' />
                        </div>
                    </a>
                </div>
            </div>
            ...
            <div id='about' ref={el => sections.current['#about'] = el} className='flex sm:mt-20 mt-16'>
                ...
                <div className='ms-2 md:ms-10 '>
                    ...
                    <div className='mt-5 flex justify-center md:justify-start'>
                        <a 
                            href={`${process.env.PUBLIC_URL}/Resume_Adithyu_R.pdf`} download="Adithyu_R_CV.pdf"
